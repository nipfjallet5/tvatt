    ...
    constructor(date) {
        ...
        template.innerHTML = /*html*/`
            ...
            <div class="cleantasks">
                    ...
                    <div class=cleantask><div style="height: 20px">filter tumlare</div><div style="height: 20px"><input type="checkbox" id="switch4_${this.uuid}" /><label for="switch4_${this.uuid}"></label></div></div>
